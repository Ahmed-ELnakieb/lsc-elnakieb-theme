...
class Eergx_Contact_Form_Two extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Eergx Contact Form Two', 'eergx-plugin' );
	}
	...
	protected function render() {
		...
		require __DIR__ . '/contact-template/contact-2.php';
    }
...
Plugin::instance()->widgets_manager->register( new Eergx_Contact_Form_Two() );