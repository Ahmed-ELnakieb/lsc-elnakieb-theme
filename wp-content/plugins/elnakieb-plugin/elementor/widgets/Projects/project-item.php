...
class Eergx_Projects_Two extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Projects Item Two', 'eergx-plugin' );
	}
	...
	protected function render() {
        ...
        require __DIR__ . '/project-template/project-4.php';
    }
...
Plugin::instance()->widgets_manager->register( new Eergx_Projects_Two() );