...
class Eergx_Projects_Filter extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Projects Filter', 'eergx-plugin' );
	}
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
			'--project-option',
			[
				'label' => esc_html__( 'Project Option', 'eergx-plugin' ),
        ...
        $repeater->add_control(
			'filter_id', [
				'label' => esc_html__( 'Filter ID', 'gtbus-plugin' ),
        ...
        $repeater->add_control(
			'filter_cat', [
				'label' => esc_html__( 'Filter Categpry', 'gtbus-plugin' ),
				'type' => Controls_Manager::TEXT,
                'label_block' => true,
			]
		);
        ...
        $repeater->add_control(
			'project_img', [
				'label' => esc_html__( 'Project Image', 'eergx-plugin' ),
        ...
        $repeater->add_control(
			'filter_id', [
				'label' => esc_html__( 'Filter Title', 'eergx-plugin' ),
				'type' => Controls_Manager::TEXT,
                'label_block' => true,
			]
		);
		...
		$this->start_controls_section(
			'project__box-style',
			[
				'label' => esc_html__( 'project Box Style', 'eergx-plugin' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .fx-projects-2-card' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        $this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .fx-projects-2-card' => 'background: {{VALUE}}',
				],
			]
		);
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .fx-projects-2-card:not(:last-child)' => 'border-color: {{VALUE}}',
					'{{WRAPPER}} .fx-projects-2-wrap' => 'border-color: {{VALUE}}'
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .fx-projects-2-card .card-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .fx-projects-2-card .card-title' => 'color: {{VALUE}}',
				],
			]
		);
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .fx-projects-2-card .card-title:hover' => 'color: {{VALUE}}',
				],
			]
		);
		// typography
		$this->add_group_control(
			...
			[
				...
				'name' => 'm_s_typography',
				'selector' => '{{WRAPPER}} .fx-projects-2-card .card-title',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .fx-projects-2-card .card-disc' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .fx-projects-2-card .card-disc' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .fx-projects-2-card .card-disc',
			]
		);
	...
	protected function render() {
        ...
        require __DIR__ . '/project-template/project-2.php';
    }
...
Plugin::instance()->widgets_manager->register( new Eergx_Projects_Filter() );