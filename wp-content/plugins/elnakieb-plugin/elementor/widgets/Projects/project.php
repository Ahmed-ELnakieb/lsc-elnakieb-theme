...
class Eergx_Projects extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Projects Item', 'eergx-plugin' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			'info', [
				'label' => esc_html__( 'Info', 'gtbus-plugin' ),
...
Plugin::instance()->widgets_manager->register( new Eergx_Projects() );