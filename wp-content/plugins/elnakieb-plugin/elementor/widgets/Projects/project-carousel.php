...
class Eergx_Projects_Carousel extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Projects Carousel', 'eergx-plugin' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			'arrow', [
				'label' => esc_html__( 'Arrow Image', 'gesto-plugin' ),
        ...
        $repeater->add_control(
			'project_img', [
				'label' => esc_html__( 'Project Image', 'gesto-plugin' ),
				'type' => Controls_Manager::MEDIA,
                'label_block' => true,
			]
		);
        ...
        $repeater->add_control(
			'category', [
				'label' => esc_html__( 'Category', 'gtbus-plugin' ),
	...
	protected function render() {
        ...
        require __DIR__ . '/project-template/project-3.php';
    }
...
Plugin::instance()->widgets_manager->register( new Eergx_Projects_Carousel() );