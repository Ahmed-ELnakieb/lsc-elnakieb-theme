...
class Eergx_About_Three extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Eergx About Three', 'eergx-plugin' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			'title2', [
				'label' => esc_html__( 'Title 2', 'eergx-plugin' ),
				'default' => esc_html__( 'Section Title', 'eergx-plugin' ),
				'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
			]
	...
	protected function render() {
        ...
        require __DIR__ . '/about-template/content-3.php';
    }
...
Plugin::instance()->widgets_manager->register( new Eergx_About_Three() );