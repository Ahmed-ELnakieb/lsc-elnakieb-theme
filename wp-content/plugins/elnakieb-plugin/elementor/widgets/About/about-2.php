...
class Eergx_About_Two extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Eergx About Two', 'eergx-plugin' );
	}
	...
	protected function render() {
        ...
        require __DIR__ . '/about-template/content-2.php';
    }
...
Plugin::instance()->widgets_manager->register( new Eergx_About_Two() );