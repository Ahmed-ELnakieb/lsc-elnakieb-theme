...
class Eergx_Message extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Message', 'eergx-plugin' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'int_widget_opt',
			[
				'label' => esc_html__( 'Message Select', 'eergx-plugin' ),
	...
	protected function render() {
		...
		require __DIR__ . '/message-template/message-' . $settings['style'] . '.php';
    }
...
Plugin::instance()->widgets_manager->register( new Eergx_Message() );