...
class Eergx_Saving_Banner_Two extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Eergx Saving Banner Two', 'eergx-plugin' );
	}
	...
	protected function render() {
		...
		require __DIR__ . '/saving-banner/banner-2.php';
    }
...
Plugin::instance()->widgets_manager->register( new Eergx_Saving_Banner_Two() );