...
class Eergx_Pricing extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Eergx Pricing', 'eergx-plugin' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			'shape', [
				'label' => esc_html__( 'Shape Image', 'gesto-plugin' ),
        ...
        $this->add_control(
			'currency', [
				'label' => esc_html__( 'Currency', 'eergx-plugin' ),
				'default' => esc_html__( 'Currency', 'eergx-plugin' ),
				'type' => Controls_Manager::TEXT,
			]
		);
	...
	protected function render() {
        ...
        require __DIR__ . '/pricing-template/pricing-1.php';
    }
...
Plugin::instance()->widgets_manager->register( new Eergx_Pricing() );