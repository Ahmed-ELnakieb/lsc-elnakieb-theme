...
class Counter_Item extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Counter Item', 'eergx-plugin' );
	}
	...
	protected function render() {
        ...
        require __DIR__ . '/counter-template/counter-2.php';
    }
...
Plugin::instance()->widgets_manager->register( new Counter_Item() );