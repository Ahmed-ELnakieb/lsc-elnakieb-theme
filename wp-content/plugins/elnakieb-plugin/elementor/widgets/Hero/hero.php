...
class Eergx_Hero_One extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Eergx Hero 1', 'eergx-plugin' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			'img_5',
			[
				'label' => esc_html__( 'Image 5', 'eergx-plugin' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
			]
		);
	...
	protected function render() {
		...
		require __DIR__ . '/hero-template/hero-1.php';
    }
...
Plugin::instance()->widgets_manager->register( new Eergx_Hero_One() );