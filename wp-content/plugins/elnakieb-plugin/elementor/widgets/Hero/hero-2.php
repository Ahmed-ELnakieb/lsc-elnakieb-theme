...
class Eergx_Hero_Two extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Eergx Hero 2', 'eergx-plugin' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			'bg_img',
			[
				'label' => esc_html__( 'Background Image', 'eergx-plugin' ),
        ...
        $this->add_control(
			'btn_label_2', [
				'label' => esc_html__( 'Button Two Label', 'eergx-plugin' ),
				'default' => esc_html__( 'competitive', 'eergx-plugin' ),
				'type' => Controls_Manager::TEXT,
                'label_block' => true,
			]
        ...
        $this->add_control(
			'btn_link_2', [
				'label' => esc_html__( 'Button 2 Link', 'eergx-plugin' ),
				'type' => Controls_Manager::URL,
                'label_block' => true,
			]
		);
        ...
        $this->add_control(
			'video_txt', [
				'label' => esc_html__( 'Video Text', 'eergx-plugin' ),
				'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
			]
		);
	...
	protected function render() {
		...
		require __DIR__ . '/hero-template/hero-2.php';
    }
...
Plugin::instance()->widgets_manager->register( new Eergx_Hero_Two() );