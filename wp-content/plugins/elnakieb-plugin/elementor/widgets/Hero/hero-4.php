...
class Eergx_Hero_Slider extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Eergx Hero Slider', 'eergx-plugin' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			'img_3',
			[
				'label' => esc_html__( 'Image 3', 'eergx-plugin' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
			]
		);
        $this->add_control(
			'img_4',
			[
				'label' => esc_html__( 'Image 4', 'eergx-plugin' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
			]
		);
        ...
        $repeater->add_control(
			'slide_img', [
				'label' => esc_html__( 'Slider Image', 'eergx-plugin' ),
        ...
        $repeater->add_control(
			'text', [
				'label' => esc_html__( 'Text', 'eergx-plugin' ),
        ...
        $this->add_control(
			'sliders',
			[
				'label' => esc_html__( 'Add Slider Item', 'eergx-plugin' ),
        ...
        $repeater->add_control(
			'link', [
				'label' => esc_html__( 'Link', 'gesto-plugin' ),
				'type' => Controls_Manager::URL,
                'label_block' => true,
			]
		);
	...
	protected function render() {
		...
		require __DIR__ . '/hero-template/hero-4.php';
    }
...
Plugin::instance()->widgets_manager->register( new Eergx_Hero_Slider() );