...
class Eergx_Footer_Cta_Three extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Footer CTA 3', 'eergx-plugin' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			'copyright', [
				'label' => esc_html__( 'Copyright', 'eergx-plugin' ),
				'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
			]
		);
	...
	protected function render() {
		...
		require __DIR__ . '/footer-template/footer-cta-3.php';
    }
...
Plugin::instance()->widgets_manager->register( new Eergx_Footer_Cta_Three() );