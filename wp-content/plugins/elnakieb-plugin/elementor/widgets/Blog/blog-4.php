...
class Eergx_Blog_Four extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Eergx Blog Four', 'eergx-plugin' );
	}
	...
	protected function render() {
        ...
        require __DIR__ . '/blog-template/blog-4.php';
    }
...
Plugin::instance()->widgets_manager->register( new Eergx_Blog_Four() );