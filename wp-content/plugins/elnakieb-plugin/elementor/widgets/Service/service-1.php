...
class Eergx_Service_Item extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Service Item', 'eergx-plugin' );
	}
	...
	protected function register_controls() {
        ...
        $repeater->add_control(
			'custom_class', [
				'label' => esc_html__( 'Custom Class', 'gtbus-plugin' ),
				'type' => Controls_Manager::TEXT,
                'label_block' => true,
			]
		);
	...
	protected function render() {
        ...
        require __DIR__ . '/service-template/service-1.php';
    }
...
Plugin::instance()->widgets_manager->register( new Eergx_Service_Item() );