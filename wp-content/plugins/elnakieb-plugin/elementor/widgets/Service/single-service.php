...
class Eergx_Single_Service extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Single Service', 'eergx-plugin' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			'btn_link', [
				'label' => esc_html__( 'Button Link', 'gtbus-plugin' ),
	...
	protected function render() {
        ...
        require __DIR__ . '/service-template/single.php';
    }
...
Plugin::instance()->widgets_manager->register( new Eergx_Single_Service() );