...
class Eergx_Service_Item_Four extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Service Item 4', 'eergx-plugin' );
	}
	...
	protected function register_controls() {
        ...
        $repeater->add_control(
			'anims', [
				'label' => esc_html__( 'Animation Speed', 'gesto-plugin' ),
        ...
        $repeater->add_control(
			'service_bg_img', [
				'label' => esc_html__( 'Service BG Image', 'gesto-plugin' ),
	...
	protected function render() {
        ...
        require __DIR__ . '/service-template/service-4.php';
    }
...
Plugin::instance()->widgets_manager->register( new Eergx_Service_Item_Four() );