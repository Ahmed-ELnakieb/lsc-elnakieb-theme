...
class Eergx_Service_Item_Three extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Service Item 3', 'eergx-plugin' );
	}
	...
	protected function render() {
        ...
        require __DIR__ . '/service-template/service-3.php';
    }
...
Plugin::instance()->widgets_manager->register( new Eergx_Service_Item_Three() );