...
class Eergx_Team extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Team', 'eergx-plugin' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'team_bg_img', [
				'label' => esc_html__( 'Team BG Image', 'gesto-plugin' ),
		...
		$this->add_control(
			'info', [
				'label' => esc_html__( 'Team Info', 'gesto-plugin' ),
	...
	protected function render() {
        ...
        require __DIR__ . '/team-template/team-2.php';
    }
...
Plugin::instance()->widgets_manager->register( new Eergx_Team() );