<?php
/**
 *eergx Bootstrap Navwalker
 *
 * @packageeergx-Bootstrap-Navwalker
 *
 */

// Check if Class Exists.
if (!class_exists('Elnakieb_Bootstrap_Navwalker')) {
	/**
	 * Elnakieb_Bootstrap_Navwalker class.
	 */
	class Elnakieb_Bootstrap_Navwalker extends Walker_Nav_Menu
	{
		...
		public static function fallback($args)
		{
			...
			$fallback_output .= '<li class="nav-item"><a href="' . esc_url(admin_url('nav-menus.php')) . '" class="nav-link" title="' . esc_attr__('Add a menu', 'eergx') . '">' . esc_html__('Add a menu', 'eergx') . '</a></li>';
			$fallback_output .= '</ul>';
